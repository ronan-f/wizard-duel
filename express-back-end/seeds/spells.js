  ...
  return knex('spells').del()
    .then(function () {
      ...
      return knex('spells').insert([
        ...
        {id: 7, name: 'Bombarda', description:'Deals 2 damage from the explosive nature of the charm.', cost: 1, cast_limit: 1, power: 2, turns: 1, affect_opponent: false, unlock_level: 2, light: true, dark: true},
        ...
        {id: 9, name: 'Bombarda', description:'Deals 8 damage from the explosive nature of the charm.', cost: 3, cast_limit: 3, power: 8, turns: 1, affect_opponent: false, unlock_level: 6, light: true, dark: true},
        {id: 10, name: 'Bombarda', description:'Deals 9 damage from the explosive nature of the charm.', cost: 4, cast_limit: 4, power: 9, turns: 1, affect_opponent: false, unlock_level: 8, light: true, dark: true},
        ...
        {id: 15, name: 'Sectumsempra', description:'Deals 12 damage to your opponent.', cost: 13, cast_limit: 1, power: 12, turns: 1, affect_opponent: false, unlock_level: 6, light: false , dark: true},
        {id: 16, name: 'Sectumsempra', description:'Deals 15 damage to your opponent.', cost: 20, cast_limit: 1, power: 15, turns: 1, affect_opponent: false, unlock_level: 8, light: false , dark: true},
        ...
        {id: 19, name: 'Aqua Eructo', description:'Torrent of water shoots at opponent, causing 12 damage.', cost: 7, cast_limit: 3, power: 12, turns: 1, affect_opponent: false, unlock_level: 7, light: true, dark: true},
        {id: 20, name: 'Aqua Eructo', description:'Torrent of water shoots at opponent, causing 15 damage.', cost: 7, cast_limit: 2, power: 12, turns: 1, affect_opponent: false, unlock_level: 9, light: true, dark: true},
        ...
        {id: 24, name: 'Repello Inimicum', description:'A defensive spell causing 9 damage.', cost: 9, cast_limit: 1, power: 8, turns: 1, affect_opponent: false, unlock_level: 4, light: true , dark: false},
        ...
        {id: 27, name: 'Vulnera Sanentur', description:'Severely damages opponents shield, causes dark soul to crumble when it lands. Damage 30', cost: 29, cast_limit: 1, power: 30, turns: 1, affect_opponent: false, unlock_level: 6, light: true , dark: false},
        {id: 28, name: 'Vulnera Sanentur', description:'Severely damages opponents shield, causes dark soul to crumble when it lands. Damage 30', cost: 31, cast_limit: 1, power: 30, turns: 1, affect_opponent: false, unlock_level: 7, light: true , dark: false},
        {id: 29, name: 'Vulnera Sanentur', description:'Severely damages opponents shield, causes dark soul to crumble when it lands. Damage 40', cost: 39, cast_limit: 1, power: 40, turns: 1, affect_opponent: false, unlock_level: 9, light: true , dark: false},

        {id: 30, name: 'Protego', description:'Boosts your defence by 2.', cost: 0, cast_limit: 100, power: 2, turns: 1, affect_opponent: false, unlock_level: 1, light: true, dark: true},
        {id: 31, name: 'Protego', description:'Boosts your defence by 3.', cost: 0, cast_limit: 100, power: 3, turns: 1, affect_opponent: false, unlock_level: 3, light: true, dark: true},
        {id: 32, name: 'Protego', description:'Boosts your defence by 5.', cost: 0, cast_limit: 100, power: 5, turns: 1, affect_opponent: false, unlock_level: 5, light: true, dark: true},
        {id: 33, name: 'Protego', description:'Boosts your defence by 7.', cost: 0, cast_limit: 100, power: 7, turns: 1, affect_opponent: false, unlock_level: 7, light: true, dark: true},
        {id: 34, name: 'Protego', description:'Boosts your defence by 9.', cost: 0, cast_limit: 100, power: 9, turns: 1, affect_opponent: false, unlock_level: 9, light: true, dark: true},
